...
def prepare_dirs(config):
  ...
  config.tblog_dir = os.path.join(config.log_dir, config.model_name)
  config.model_dir = os.path.join(config.mdl_dir, config.model_name)
  ...
  for path in [config.log_dir, config.tblog_dir,
