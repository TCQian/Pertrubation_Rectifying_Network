...
train_arg.add_argument('--max_step', type=int, default=1, help='')
...
train_arg.add_argument('--nnclassifier_pretrained_model', type=str, default='../data/tensorflow_inception_graph.pb', help='')
